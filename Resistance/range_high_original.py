...
def resistance(ticker):
    df = pd.read_csv(r"C:/Users/Hp/Desktop/New folder/5 minute stock data/5 minute stock data/" + ticker + ".csv")
    if len(df.columns) >= 6:
...
def get_ticker_list():
    with open(r"C:\Users\Hp\Desktop\New folder\EQUITY_L.csv", 'r') as f:
        lines = csv.reader(f)
        for line in lines:
...
def main():
    ...
    """SAVING IN CSV"""
    sdf.to_csv(r"C:/Users/Hp/Desktop/New folder/resistance.csv")
    """SAVING IN XLSX"""
